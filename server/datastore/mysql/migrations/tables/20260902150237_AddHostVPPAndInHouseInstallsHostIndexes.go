...
// Up_20260902150237 adds host_id-leading indexes to host_vpp_software_installs
// and host_in_house_software_installs. The per-host software detail queries
// (ListHostSoftware) filter these tables by host_id.
