...
// GenerateRandomPwd generates a random base (≈20 base64 chars) and append "1!" to guarantee
// at least one digit and one symbol so Fleet's password requirements are met.
